...
>(
  ...
  // Filter out incompatible props - exclude form-related attributes
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { formAction, formEncType, formMethod, formNoValidate, formTarget, ...buttonProps } = props as Record<string, unknown>
